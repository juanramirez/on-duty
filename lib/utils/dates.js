...
import {getUnixTime, isAfter, isBefore, isSameDay, parse} from 'date-fns';
...
export const timestampDayIsBetween = ({timestamp, range: {startTimestamp, endTimestamp}}) =>
    (isSameDay(timestamp, startTimestamp) || isAfter(timestamp, startTimestamp)) &&
    (isSameDay(timestamp, endTimestamp) || isBefore(timestamp, endTimestamp));
