...
import {weekdayFromDate, weekdayFromTimestamp} from "../utils/weekdays.js";
import {getOnDutyDoctorId} from "../utils/schedule.js";
import {notConsecutiveWeekdays} from "../../config/weekdays.js";
...
const canBeAssigned = ({timestamp, doctorId, schedule}) =>
    every(notConsecutiveWeekdays[weekdayFromTimestamp({timestamp})], weekday =>
        getOnDutyDoctorId({
